...
function Slider ({ className }) {
  return (
    ...
    >
      <defs>
        <linearGradient id="hextech-slider-idle" gradientUnits="userSpaceOnUse" x1="47.8707" y1="0" x2="47.8707" y2="95.7529">
          <stop offset="0" stopColor="#A07B2E" />
          <stop offset="0.8" stopColor="#6F5325" />
        </linearGradient>
        <linearGradient id="hextech-slider-hover" gradientUnits="userSpaceOnUse" x1="47.8707" y1="0" x2="47.8707" y2="95.7529">
          <stop stopColor="#ecdfc6" />
          <stop offset="0.8" stopColor="#c89d3e" />
        </linearGradient>
        <linearGradient id="hextech-slider-active" gradientUnits="userSpaceOnUse" x1="47.8707" y1="0" x2="47.8707" y2="95.7529">
          <stop stopColor="#493915" />
          <stop offset="0.8" stopColor="#684e22" />
        </linearGradient>
      </defs>
      <polygon points="47.7,95.8 0,48.1 47.6,0 95.7,47.8 47.7,95.8 " />
      <g>
      ...
      <g>
        ...
        <rect x="41.5" y="41.8" transform="matrix(-0.7071 0.7071 -0.7071 -0.7071 116.2931 47.964)" fill="#1E2328" width="13.4" height="12.5" />
        <path
